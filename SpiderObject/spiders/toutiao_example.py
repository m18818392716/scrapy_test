...
class ToutiaoExampleSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for aa in conten_news['pc_feed_focus']:
            title = aa['title']
            link_url = 'https://www.toutiao.com' + aa[
                'display_url']  ###如果写（www.toutiao.com'+aa['display_url']）会报错，加上https://,(https://www.toutiao.com'+aa['display_url'])则不会报错！
